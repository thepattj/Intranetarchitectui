...
class Chih extends CI_Controller {
	...
	public function AFR1302216L1(){
		$namesta = "AUTOGAS DE LA FRONTERA";
		$nameU = $this->session->userdata('nombreU');
	...
	public function DGM880621FU5(){
		$namesta = "DISTRIBUIDORA GASO MEX";
		$nameU = $this->session->userdata('nombreU');
	...
	public function SOLF3703038C2(){
		$namesta = "FRANCISCO SORIA LUNA";
		$nameU = $this->session->userdata('nombreU');
	...
	public function DIRL580912V96(){
		$namesta = "LOURDES IRENE DIAZ ROMERO";
		$nameU = $this->session->userdata('nombreU');
	...
	public function RAMJ500311A56(){
		$namesta = "JUAN FELIPE RAMIREZ MARTINEZ";
		$nameU = $this->session->userdata('nombreU');
	...
	public function SIGG330219EI0(){
		$namesta = "GABINA GUADALUPE SIFUENTES GUTIERREZ";
		$nameU = $this->session->userdata('nombreU');
	...
	public function SIM000324HN9(){
		$namesta = "SERVICIO IMPERIAL DE MEXICO";
		$nameU = $this->session->userdata('nombreU');
	...
	public function SNM981008336(){
		$namesta = "SERVICIO NUEVO MILENIO";
		$nameU = $this->session->userdata('nombreU');
	...
	public function SNR960621UZA(){
		$namesta = "SERVICIO NUEVA REFORMA";
		$nameU = $this->session->userdata('nombreU');
	...
	public function SPS840928PE5(){
		$namesta = "SERVICIO PLAZA SAN FELIPE";
		$nameU = $this->session->userdata('nombreU');
