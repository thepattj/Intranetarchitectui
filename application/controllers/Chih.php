...
class Chih extends CI_Controller {
	...
	public function ORA0507116F4(){
		# code...
	}
	public function PETROMUAL(){
		# code...
	}
	...
	public function SNM981008337(){
		# code...
	}
	public function SOA960322B59(){
		# code...
	}
	...
	public function PL1743(){
		$this->load->view('estacion/header');
		$this->load->view('estacion/chih/PL1743');
		$this->load->view('estacion/footer');
	}
	public function PL1745(){
		$this->load->view('estacion/header');
		$this->load->view('estacion/chih/PL1745');
		$this->load->view('estacion/footer');
	}
