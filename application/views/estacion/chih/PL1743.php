                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="" id="" placeholder="" type="text" value="<?php echo $row->numeroEst; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                                <label for="" class="">Franquicia</label>
                                                <input name="" id="" placeholder="" type="text" value="<?php echo $row->franquicia; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                                <label for="" class="">R.F.C.</label>
                                                <input name="" id="" placeholder="" type="text" value="<?php echo $row->rfc; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                                <label for="" class="">Dirección</label>
                                                <input name="" id="" placeholder="" type="text" value="<?php echo $row->direccionP; ?>" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="" id="" placeholder="" type="text" value="<?php echo $row->nombreCompleto; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="" id="" placeholder="" type="text" value="<?php echo $row->CURP; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="position-relative form-group">
