        ...
        <div class="app-main">
                <div class="app-sidebar sidebar-shadow">
                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="row">
                            <?php 
                                $sqlestacion8 = "SELECT razonSocial as nombre, rfc as clave FROM cliente WHERE idEstado = 14 GROUP BY razonSocial ORDER BY razonSocial ASC";
                                $resultado8 = mysqli_query($con, $sqlestacion8);
                                while ($row = $resultado8->fetch_object()) { ?>
                                <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content" style="cursor: pointer;" href="estaciones/<?php echo ($row->clave); ?>">
